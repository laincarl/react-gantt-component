...
const TimeAxisScaleSelect: React.FC = () => {
  ...
  return (
    <div className={styles['time-axis-scale-select']} ref={ref}>
      <div role="none" className={styles.trigger} onClick={handleClick}>
      ...
      <div
        className={classNames(styles.shadow, { [styles.scrolling]: scrolling })}
      />
      {visible && (
        <div
          className={classNames(styles['next-overlay-wrapper'], styles.opened)}
        >
          <div
          ...
          >
            <div className={styles['next-loading-wrap']}>
              <ul
                role="listbox"
                className={classNames(styles['next-menu'])}
              ...
              >
                {viewTypeList.map(item => (
                  <li
                    ...
                    className={classNames(styles['next-menu-item'], {
                      [styles['next-selected']]: isSelected(item.type),
                    })}
                  >
                    {isSelected(item.type) && (
                      <i className={styles.selected_icon}>
                    ...
                    <span
                      className={styles['next-menu-item-text']}
                      aria-selected="true"
                    >
                      {item.label}
                    </span>
